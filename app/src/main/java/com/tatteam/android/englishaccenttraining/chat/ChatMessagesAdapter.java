...
public class ChatMessagesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof MyMessViewHolder) {
            ((MyMessViewHolder) holder).bindData(mMessageList.get(position), mContext);
    ...
    public class MyMessViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyMessViewHolder(View itemView) {
            ...
            mLayoutMessage = itemView.findViewById(R.id.layout_message);
        }

        public void bindData(ChatMessage chatMessage, Context context) {
            mTextContent.setText(chatMessage.content);
            ...
            switch (chatMessage.state) {
                case ChatMessage.STATE_SENDING:
                    mLayoutMessage.setBackgroundColor(context.getResources().getColor(R.color.my_chat_sending));
//                    mImageSend.setImageResource(R.drawable.ic_sending);
                ...
                case ChatMessage.STATE_ERROR:
                    ...
                    break;
                default:
                    mLayoutMessage.setBackgroundColor(context.getResources().getColor(R.color.my_chat_bg));
